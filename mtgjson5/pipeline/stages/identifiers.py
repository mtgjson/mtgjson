...
def add_identifiers_struct(lf: pl.LazyFrame) -> pl.LazyFrame:
    ...
    return lf.with_columns(
        pl.struct(
            ...
            cardtraderId=pl.col("cardtraderId"),
            cardsphereId=pl.col("cardsphereId"),
            cardsphereAlternativeFoilId=pl.col("cardsphereAlternativeFoilId"),
            cardsphereEtchedId=pl.col("cardsphereEtchedId"),
...
def join_identifiers(
    ...
    if ctx.identifiers_lf is None:
        ...
        return lf.with_columns(
            ...
            pl.lit(None).cast(pl.String).alias("cardtraderId"),
