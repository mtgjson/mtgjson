...
STAGE_POST_EXPLODE = StageSchema(
    ...
    required=[
        ColumnSpec("_row_id", pl.UInt32),  # type: ignore[arg-type]
        ColumnSpec("faceId", pl.Int64),  # type: ignore[arg-type]
        ColumnSpec("side", pl.String),  # type: ignore[arg-type]
...
STAGE_POST_BASIC_FIELDS = StageSchema(
    ...
    required=[
        ColumnSpec("name", pl.String),  # type: ignore[arg-type]
        ColumnSpec("setCode", pl.String),  # type: ignore[arg-type]
        ColumnSpec("number", pl.String),  # type: ignore[arg-type]
        ColumnSpec("scryfallId", pl.String),  # type: ignore[arg-type]
        ColumnSpec("language", pl.String),  # type: ignore[arg-type]
        ColumnSpec("type", pl.String),  # type: ignore[arg-type]
        ColumnSpec("manaValue", pl.Float64),  # type: ignore[arg-type]
    ],
...
STAGE_POST_IDENTIFIERS = StageSchema(
    ...
    required=[
        ...
        ColumnSpec("uuid", pl.String),  # type: ignore[arg-type]
    ],
