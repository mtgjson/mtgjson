import re 
import datetime
from typing import Any, Dict, Set, ClassVar, Iterable
...
class MTGJsonCardModel(MTGJsonBaseModel):
    ...
    _exclude_for_tokens: ClassVar[Set[str]] = {
        "rulings", "rarity", "prices", "purchase_urls", "printings",
        "converted_mana_cost", "mana_value", "foreign_data", "legalities", "leadership_skills",
    }
