...
class PolarsMixin:
    ...
    _sorted_list_fields: ClassVar[frozenset[str]] = SORTED_LIST_FIELDS
    _allow_if_falsey: ClassVar[frozenset[str]] = ALLOW_IF_FALSEY
    ...
    def polars_schema(cls) -> Schema:
        ...
        schema = {}
        for name in sorted(cls.model_fields.keys()):  # type: ignore[attr-defined]
            info = cls.model_fields[name]  # type: ignore[attr-defined]
                ...
                if origin is list and args:
                    ...
                    if isinstance(inner, type) and issubclass(inner, BaseModel):
                        result[field_name] = [  # type: ignore[assignment]
                            cls._from_row_recursive(v, inner) for v in value
                        ]
    ...
    def to_typescript(cls, indent: str = "  ") -> str:
        ...
        return TypeScriptGenerator.from_model(cls, indent)  # type: ignore[arg-type]
