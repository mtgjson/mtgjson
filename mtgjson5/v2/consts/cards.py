...
SUPER_TYPES: Final[frozenset[str]] = frozenset({"Basic", "Host", "Legendary", "Ongoing", "Snow", "World"})
"""Valid MTG supertypes."""

BASIC_LAND_NAMES: Final[frozenset[str]] = frozenset({"Plains", "Island", "Swamp", "Mountain", "Forest"})
