...
from mtgjson5.v2.build.price_archive import PRICES_PARTITION_DIR, list_local_partitions
...
def get_price_archive_from_s3(
    ...
    """
    from mtgjson5.v2.build.price_archive import load_archive
    ...
    try:
        ...
        if json_to_dataframe_fn is not None:
            ...
            from mtgjson5.v2.build.price_archive import _default_json_to_dataframe
