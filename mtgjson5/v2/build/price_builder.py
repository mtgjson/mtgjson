...
from mtgjson5.v2.build.price_archive import (
    PRICE_SCHEMA,
    load_archive,
...
from mtgjson5.v2.build.price_s3 import (
...
from mtgjson5.v2.build.price_writers import (
...
class PolarsPriceBuilder:
    ...
    def list_local_partitions(self) -> list[str]:
        ...
        from mtgjson5.v2.build.price_archive import list_local_partitions as _list_local
    ...
    def sync_partition_from_s3(self, date: str) -> bool:
        ...
        from mtgjson5.v2.build.price_s3 import sync_partition_from_s3 as _sync

        return _sync(date)

    def list_s3_partitions(self) -> list[str]:
        """List available date partitions on S3."""
        from mtgjson5.v2.build.price_s3 import list_s3_partitions as _list_s3
    ...
    def sync_partition_to_s3_with_retry(self, date: str, max_retries: int = 3, base_delay: float = 1.0) -> bool:
        ...
        from mtgjson5.v2.build.price_s3 import sync_partition_to_s3_with_retry as _sync
