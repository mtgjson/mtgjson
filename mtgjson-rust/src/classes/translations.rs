...
impl MtgjsonTranslations {
    ...
    pub fn get_available_languages(&self) -> Vec<String> {
        ...
        if self.chinese_simplified.is_some() { languages.push("Chinese Simplified".to_string()); }
        if self.chinese_traditional.is_some() { languages.push("Chinese Traditional".to_string()); }
        if self.french.is_some() { languages.push("French".to_string()); }
        if self.german.is_some() { languages.push("German".to_string()); }
        if self.italian.is_some() { languages.push("Italian".to_string()); }
        if self.japanese.is_some() { languages.push("Japanese".to_string()); }
        if self.korean.is_some() { languages.push("Korean".to_string()); }
        if self.portuguese_brazil.is_some() { languages.push("Portuguese (Brazil)".to_string()); }
        if self.russian.is_some() { languages.push("Russian".to_string()); }
        if self.spanish.is_some() { languages.push("Spanish".to_string()); }
