...
#[pyclass(name = "GitHubCardSealedProductsProvider")]
...
impl GitHubCardSealedProductsProvider {
    ...
    pub fn new() -> PyResult<Self> {
        ...
        let base = BaseProvider::new("gh_sealed_products".to_string(), headers);
        Ok(Self { base })
    }
}

#[async_trait]
impl AbstractProvider for GitHubCardSealedProductsProvider {
